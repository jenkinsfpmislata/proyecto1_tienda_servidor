...
$SQL = "UPDATE proyecto1_tienda_servidor.articulos SET nombreArticulo='$nombreArticulo',descripcionArticulo='$descripcionArticulo',precioArticulo='$precioArticulo',idCategorias='$idCategorias', oferta='$oferta' WHERE idArticulo='$idArticulo';";
